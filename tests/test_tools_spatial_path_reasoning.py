...
dotenv.load_dotenv()
spr = SpatialPathReasoner(openrouter_api_key=os.getenv("OPENROUTER_API_KEY") or os.getenv("GEMINI_API_KEY"), model="gemini-3-pro-preview")
...
def test_gemini_path_reasoning(challenge_screenshot: Path):
...
def test_gemini_path_reasoning_sequential():
